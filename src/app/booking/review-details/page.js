'use client';
import styles from './review-details.module.css';
...
export default function ReviewDetails() {
  ...
  const totalAmount = 12 * totalQuantity + additionalPrice * totalQuantity;
  ...
  return (
    <div className={styles.box}>
      <div className={styles.section}>
        ...
        <div className={styles.detail}>
          <span>Base Price:</span> ${12 * totalQuantity}
        </div>
        <div className={styles.detail}>
          <span>Additional Price (Validity):</span>
          {additionalPrice === 0 ? '$0' : `$${additionalPrice * totalQuantity}`}
        </div>
